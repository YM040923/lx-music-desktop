...
div(:class="$style.footerLeftControlBtns")
  ...
  common-sound-effect-btn(play-detail)
  common-playback-rate-btn(play-detail)
  common-volume-btn(play-detail)
  common-start-play-timer-btn(play-detail @show="handleShowTimer")
  common-current-playlist-btn(play-detail @show="handleShowPlaylist")
  common-toggle-play-mode-btn(play-detail)

...
dd
  .p.small
    strong YM Music
    |  是基于开源项目
    span.hover.underline(:aria-label="$t('setting__click_open')" @click="openUrl('https://github.com/lyswhut/lx-music-desktop#readme')")  LX Music
  ...
  .p.small
    | 感谢 LX Music 原作者
    strong  落雪无痕
    |  及社区贡献者，本分支仅作为个人 fork 版本继续做界面方向的优化。
